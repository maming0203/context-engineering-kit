...
以下是 `mini_jit` 引擎的核心组装逻辑（完整实现见仓库 `reference/mini_jit/`）：
...
**👉 [github.com/maming0203/context-engineering-kit](https://github.com/maming0203/context-engineering-kit)**
...
├── reference/
│   └── mini_jit/                # 最小 JIT 引擎（Python 参考实现）
