...
```bash
# 克隆仓库
git clone https://github.com/your-org/context-engineering-kit.git
...
# 运行示例（即将推出）
python scripts/assemble.py --recipe examples/break-even/recipe.json --input "帮我算盈亏平衡点"
```
